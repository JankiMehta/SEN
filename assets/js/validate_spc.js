...
function validateForm() {
	...
	document.getElementById("SPCmember_id1").innerHTML="";
	...
	var flag= true;
	var id= document.form1.SPCmember_id.value;
	...
	var post=document.form1.post.value;
		...
		if(id.length!=9){
			document.getElementById("SPCmember_id1").innerHTML="ID length should be less than 9."
			flag = false;
		}
		if(id.length==9){
			if(isNaN(id)){
				document.getElementById("SPCmember_id1").innerHTML="Id should be a number"
				flag = false;
			}
		}
		if(fname.length>50){
